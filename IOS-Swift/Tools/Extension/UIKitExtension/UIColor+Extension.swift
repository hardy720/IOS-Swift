...
public extension UIColor {
    ...
    ///   - alpha: 透明度
    /// - Returns: 返回 UIColor
    class func color(r: CGFloat, g: CGFloat, b: CGFloat, alpha: CGFloat = 1.0) -> UIColor {
    ...
    class func hexIntColor(hexInt: Int, alpha: CGFloat = 1) -> UIColor {
...
public extension UIColor {
    ...
    /// - Returns: 返回 RGB
    class func hexStringToColorRGB(hexString: String) -> (r: CGFloat?, g: CGFloat?, b: CGFloat?) {
        // 1、判断字符串的长度是否符合
    ...
    func colorToRGBA() -> (r: CGFloat?, g: CGFloat?, b: CGFloat?, a: CGFloat?) {
        ...
        return ("\(Int(red * multiplier))".fl.toCGFloat(), "\(Int(green * multiplier))".fl.toCGFloat(), "\(Int(blue * multiplier))".fl.toCGFloat(), alpha)
    }
}
...
extension UIColor {
    ...
    /// 浅灰色
    /// - Returns: 浅灰色
    class func FLGlobalColor() -> UIColor {
